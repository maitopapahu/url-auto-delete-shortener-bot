...
API_ID = int(environ.get('API_ID', '29696002'))
API_HASH = environ.get('API_HASH', 'b0402db44bb51470d0c50d3be950781b')
BOT_TOKEN = environ.get('BOT_TOKEN', "7457376044:AAGsj_PHrK8GqMUKIIUIq4bC1y6wBbX_SO4")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2040287721').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '2040287721').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://newuser:<newuser>@cluster0.0fs6z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002596945084'))
